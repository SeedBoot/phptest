<?php
	$title = "SeedBoot Dynamix";

	include("includes/head.php");
?>
<main>
<p>This guy is a web developer. He is making dynamic pages for ease of use. Magical blue sky properties you could have never imagined, you can now actually imagine thanks to this guy.</p>
<p>Seriously, he's a top dog. Mega cool, and hip to be around!</p>
